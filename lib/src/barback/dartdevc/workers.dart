...
final dartdevcDriver = new BazelWorkerDriver(() => Process.start(
    p.join(sdkDir.path, 'bin', 'dartdevc$_batOnWindows'),
    ['--persistent_worker']));
// p.join(sdkDir.path, 'bin', 'dart'),
// [
//   'C:\\Users\\Jake\\Desktop\\git\\sdk\\pkg\\dev_compiler\\bin\\dartdevc.dart',
//   '--persistent_worker'
// ]));
